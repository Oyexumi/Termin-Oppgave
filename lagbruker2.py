...
BrukernavnFyll=Entry(frame,width=25,font=('Microsot Yahei UI Light',10,'bold'),bg='white',fg='firebrick1')
BrukernavnFyll.grid(row=4,column=0,sticky='w',padx=25)


PassordBox=Label(frame,text='Passord',font=('Microsoft Yahei UI Light',10,'bold'),bg='white',fg='firebrick1')
PassordBox.grid(row=5,column=0,sticky='w',padx=25,pady=(12,0))

PassordFyll=Entry(frame,width=25,font=('Microsot Yahei UI Light',10,'bold'),bg='white',fg='firebrick1')
